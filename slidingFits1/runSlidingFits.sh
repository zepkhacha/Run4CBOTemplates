...
for window in $(seq 648 ${step} ${end}); do
...
#hadd -f ${mainDirectory}/slidingFits1/${run}_calo${calo}_windowFits.root ${outputDirectory}/${run}_calo${calo}_window{0000..2600..40}.root
