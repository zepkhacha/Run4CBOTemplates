...
# types of formats
formatA='/gm2data/zkhechad/cboTemplates/Run4CBOTemplates/templateFits3/formats/formatA_sBin_constraintOff.txt'
formatB='/gm2data/zkhechad/cboTemplates/Run4CBOTemplates/templateFits3/formats/formatB_sBin_constraintOn.txt'
formatC='/gm2data/zkhechad/cboTemplates/Run4CBOTemplates/templateFits3/formats/formatC_mBin_constraintOff.txt'
formatD='/gm2data/zkhechad/cboTemplates/Run4CBOTemplates/templateFits3/formats/formatD_mBin_constraintOn.txt'
formatE='/gm2data/zkhechad/cboTemplates/Run4CBOTemplates/templateFits3/formats/formatE_mBin_mop_constraintOn_wcboOn.txt'
