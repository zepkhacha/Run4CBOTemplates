...
//    std::vector<TGraphErrors> gSlidingVal          ;
...
//        
        gSlidingAmplitude[caloNum-1].SetPoint(graphEntry, time, slidingFit_A_CBO * 1E3);
        gSlidingAmplitude[caloNum-1].SetPointError(graphEntry, 0, slidingFit_A_CBOerr * 1E3);
//        
