...
int main(int argc, char* argv[]){
    ...
    for(int seed=desiredSeed; seed<desiredSeed+1; seed++){
        ...
        minimizer.DefineParameter(16,"Ky", 1.013, 0.00, 0.9, 2.9); // FIX, ABSORB INTO ALPHA-BETA
        minimizer.DefineParameter(17,"Ty", 30, 0, 1.0, 10000.); // FIX, ABSORB INTO ALPHA-BETA
        ...
        if (pBinCBO){
            ...
            minimizer.DefineParameter(10,"A_CNx2",  1.0, 0.01, -2.0, 2.0); // USE TO SCALE ALPHA/BETA
            minimizer.DefineParameter(11,"A_SNx2",  1.0, 0.0, -1.0, 1.0); // SUB WITH TF1
            minimizer.DefineParameter(14,"A_CNy1",  1.0, 0.01, -2.0, 2.0); // USE TO SCALE ALPHA/BETA
            minimizer.DefineParameter(15,"A_SNy1",  1.0, 0.0, -1.0, 1.0); // SUB WITH TF1
            minimizer.DefineParameter(18,"A_CNy2",  1.0, 0.01, -2.0, 2.0); // USE TO SCALE ALPHA/BETA
            minimizer.DefineParameter(19,"A_SNy2",  1.0, 0.0, -1.0, 1.0); // SUB WITH TF1
