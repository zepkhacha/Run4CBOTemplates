...
int main(int argc, char* argv[]){
    ...
    for(int seed=desiredSeed; seed<desiredSeed+1; seed++){
        ...
        minimizer.DefineParameter(5, "T_CBO", 100.0, 0.0, 1, 10000); 
        if (desiredCalo!=0){
        ...
        minimizer.DefineParameter(16,"w_y", 1.013, 0.01, 0.9, 2.9);
        ...
        if (pBinCBO){
            ...
            minimizer.DefineParameter(7, "A_CNx1",  0.0, 0.01, -2.0, 2.0); // USE TO SCALE ALPHA/BETA
